...
class PasswordHandler:
    ...
    def hash_password(self, password: str, pepper="") -> str:
        ...
        return self.hash_password_raw(password + ":" + salt + ":" + pepper) + ":" + salt + ":" + pepper

    def passwords_equal(self, password: str, hash_password: str) -> bool:
        raw_hash, salt, pepper = hash_password.split(":", 3)
        return self.hash_password(password + ":" + salt + ":" + pepper) == raw_hash
